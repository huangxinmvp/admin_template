...
public class ProjectStageServiceImpl extends ServiceImpl<ProjectStageMapper, ProjectStage> implements ProjectStageService {
    ...
    @Override
    public boolean save(ProjectStage entity) {
    ...
    @Override
    public boolean updateById(ProjectStage entity) {
    ...
    private String resolveProjectId(String id, String fallbackProjectId) {
        ...
        return lambdaQuery()
                .select(ProjectStage::getProjectId)
                .eq(ProjectStage::getId, id)
                .last("LIMIT 1")
                .oneOpt()
                .map(ProjectStage::getProjectId)
                .orElse(null);
