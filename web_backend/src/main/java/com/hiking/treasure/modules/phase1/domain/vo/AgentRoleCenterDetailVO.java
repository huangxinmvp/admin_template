...
@Data
@Schema(description = "AICoOS Agent 角色中心 - 详情")
public class AgentRoleCenterDetailVO {
    ...
    private List<AgentRoleStageParticipationVO> stageParticipations;

    @Schema(description = "允许动作配置")
    private List<AgentRoleAllowedActionVO> allowedActions;
