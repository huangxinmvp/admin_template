...
import com.hiking.treasure.modules.phase1.mapper.BudgetLedgerMapper;
...
public class BudgetLedgerServiceImpl extends ServiceImpl<BudgetLedgerMapper, BudgetLedger> implements BudgetLedgerService {

    private final ProjectGovernanceLinkageService projectGovernanceLinkageService;

    @Override
    public boolean save(BudgetLedger entity) {
    ...
    @Override
    public boolean updateById(BudgetLedger entity) {
    ...
    private String resolveProjectId(String id, String fallbackProjectId) {
        ...
        return lambdaQuery()
                .select(BudgetLedger::getProjectId)
                .eq(BudgetLedger::getId, id)
                .last("LIMIT 1")
                .oneOpt()
                .map(BudgetLedger::getProjectId)
                .orElse(null);
